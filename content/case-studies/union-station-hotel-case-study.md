...
Everything followed from that decision. The color system — Chambray Blue, Palliser Copper, the warmth of aged brass and dark wood — pulled from the building's own materials and history. The primary typeface brought the historical weight the architecture deserved. The vertical wordmark treatment echoed the station's tower. The copper foil on stationery, the illustrated Nashville map, the "out too late" door hanger, the digital press kit — each a touchpoint carrying the same voice and the same level of care.
